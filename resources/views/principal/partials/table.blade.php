<table class="w-full divide-y divide-gray-200 dark:divide-neutral-700">
  ...
  <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
    ...
    <tr>
      <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">{{ $item->order }}</td>
      <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">{{ $item->servant->name }}</td>
      <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">{{ $item->servant->email }}</td>
      <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">{{ $item->created_at }}</td>
